          ...
          children: [
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromARGB(255, 4, 156, 245), // เปลี่ยนเป็นสีเขียว
                      overlayColor: Colors.white, // ข้อความบนปุ่มเป็นสีขาว
                      shadowColor: const Color.fromARGB(255, 42, 152, 212), // เปลี่ยนสีเงาเมื่อกดปุ่ม
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromARGB(255, 68, 242, 111), // เปลี่ยนเป็นสีเขียว
                      overlayColor: Colors.white, // ข้อความบนปุ่มเป็นสีขาว
                      shadowColor: const Color.fromARGB(255, 136, 244, 54), // เปลี่ยนสีเงาเมื่อกดปุ่ม
                      elevation: 5, // เพิ่มความสูงเงาของปุ่ม
                      minimumSize: const Size(double.infinity, 50), // กำหนดขนาดความยาว
                    ),
                  onPressed: () {
